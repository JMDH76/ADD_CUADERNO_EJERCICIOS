/*4. De manera análoga al ejemplo visto en teoría, crea una clase servidor que cada vez que se 
conecte un cliente, le envíe un objeto del tipo que has creado en el ejercicio anterior para 
que el cliente lo rellene. Una vez recibido el objeto, lo deberá mostrar por pantalla. Es 
importante que te detengas en ver qué hace cada una de las instrucciones que estás utilizando.
Como no podrás testear el servidor hasta que no tengas el cliente preparado, pasa al 
...
public class Servidor {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
		...
		System.err.println("SERVIDOR >>> Envío a clienet: " + producto.getProducto() + " - " + producto.getPrecio());
